...
`;
        ...
        const imageUrl = "https://github.com/bmb200/BMB-DATA/raw/refs/heads/main/image/ping.jpg"; // Remplace "TON_LIEN_IMAGE_ICI" par ton lien d'image
        ...
        await conn.sendMessage(m.chat, {
            image: { url: imageUrl },
            caption: `📖 *BIBLE LIST BY B.M.B XMD*:\n\n` +
