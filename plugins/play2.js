...
// Send audio message 
await conn.sendMessage(from,{audio:{url:downloadUrl},mimetype:"audio/mpeg",caption :"🎧 𝗠𝘂𝘀𝗶𝗰 𝗯𝘆 ʙ.ᴍ.ʙ-xᴍᴅ-ᴠ2 🌟"},{quoted:mek})
...
// Send video message
await conn.sendMessage(from,{video:{url:downloadUrl},mimetype:"video/mp4",caption :"🎥 𝗩𝗶𝗱𝗲𝗼 𝗯𝘆 ʙ.ᴍ.ʙ-xᴍᴅ-ᴠ2 🌟"},{quoted:mek})
await conn.sendMessage(from,{document:{url:downloadUrl},mimetype:"video/mp4",fileName:deta.title + ".mp4",caption :"📥 𝗗𝗼𝘄𝗻𝗹𝗼𝗮𝗱𝗲𝗱 𝘄𝗶𝘁𝗵 ʙ.ᴍ.ʙ-xᴍᴅ-ᴠ2 💫"},{quoted:mek})
