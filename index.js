...
const port = process.env.PORT || 9090;
  ...
  let up = `*✨ Hello, B.M.B-XMD-V2 Legend! ✨*
...
*❤️ Thank you for Choosing B.M.B-XMD-V2!*
...
> _© MADE BY BMB_`;
    conn.sendMessage(conn.user.id, { image: { url: `https://files.catbox.moe/mi4qng.jpg` }, caption: up })
  }
  })
...
if (!isReact && senderNumber === botNumber) {
  ...
  app.get("/", (req, res) => {
  res.send("B.M.B-XMD-V2 IS  STARTED ✅");
  });
