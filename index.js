...
const port = process.env.PORT || 9090;
  ...
  let up = `*✨ Hello, B.M.B-XMD Legend! ✨*

╭─〔 *🤖 B.M.B-XMD BOT* 〕  
├─▸ *Simplicity. Speed. Power. BY bmb xnd |*  
╰─➤ *Your New WhatsApp Sidekick is Here!*

*❤️ Thank you for Choosing B.M.B-XMD!*

╭──〔 🔗 *Quick Links* 〕  
├─ 📢 *Join Our Channel:*  
│   Click [**Here**](https://whatsapp.com/channel/0029VawO6hgF6sn7k3SuVU3z) to join!  
├─ ⭐ *Give Us a Star:*  
│   Star Us [**Here**](https://github.com/bmbtech11/B.M.B-XMD)!  
╰─🛠️ *Prefix:* \`${prefix}\`

> _© MADE BY 𝗕.𝗠.𝗕-𝗧𝗘𝗖𝗛_`;
