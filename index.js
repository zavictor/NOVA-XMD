...
const port = process.env.PORT || 9090;
  ...
  try {
    await conn.newsletterFollow("120363382023564830@newsletter");
    console.log("📬 Followed NOVA newsletter.");
  } catch (e) {
...
╭══════════════⊷
┃ ❤️‍🩹𝗦𝗘𝗦𝗦𝗜𝗢𝗡 𝗜𝗗
┃https://session-bmb-code.onrender.com/pair
╰══════════════⊷
╭══════════════⊷
...
╰══════════════⊷`;
  ...
  const udp = botNumber.split('@')[0];
    const jawad = ('255767862457', '255772341432', '255711782669');
...
if (senderNumber.includes( ) && !isReact) {
