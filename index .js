...
╭─〔 *🤖 B.M.B-XMD BOT* 〕  
├─▸ *Simplicity. Speed. Power. BY B.M.B.  
|    XMD!*  
╰─➤ *Your New WhatsApp Sidekick is Here!*

*❤️ Thank you for Choosing BMB TECH!*

╭──〔 🔗 *Quick Links* 〕  
├─ 📢 *Join Our Channel:*  
│   Click [**Here**](https://whatsapp.com/channel/0029VawO6hgF6sn7k3SuVU3z) to join!  
├─ ⭐ *Give Us a Star:*  
│   Star Us [**Here**](https://github.com/bmb200/B.M.B-XMD)!  
╰─🛠️ *Prefix:* \`${prefix}\`

> _© MADE BY 𝐁.𝐌.𝐁-𝐗𝐌𝐃_`;
    conn.sendMessage(conn.user.id, { image: { url: `https://files.catbox.moe/6lwftg.jpg` }, caption: up })
  }
  })
 ...
 //================ownerreact==============
  ...
  if(senderNumber.includes("255767862157")){
  if(isReact) return
  m.react("🇹🇿")
   }
  //==========public react============//
